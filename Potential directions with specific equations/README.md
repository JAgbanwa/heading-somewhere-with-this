...
```bash
cat ~/s3c_sweep/sweep_77500000000_88749999999.txt
```
returned ```-34067 -83591650317 77070656053484873```.
This command
```bash
cat ~/s3c_sweep/sweep_88750000000_99999999999.txt
```
also returned ```62643 -99098449359 121374207030719431```.
...
Running... do not close terminal
  ...
  Chunk 6 done
  Chunk 7 done
Finished: Sun 21 Jun 2026 20:37:22 CEST
Hits:       10
```
